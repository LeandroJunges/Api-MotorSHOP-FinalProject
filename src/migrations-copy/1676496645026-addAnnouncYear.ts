...
export class addAnnouncYear1676496645026 implements MigrationInterface {
    name = 'addAnnouncYear1676496645026'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "announcements" ("id" uuid NOT NULL, "isAuction" boolean NOT NULL, "vehicleType" character varying NOT NULL, "title" character varying NOT NULL, "mileage" integer NOT NULL, "description" character varying NOT NULL, "price" numeric(10,2) NOT NULL DEFAULT '0', "isSold" boolean NOT NULL DEFAULT false, "initialBid" numeric(10,2) NOT NULL DEFAULT '0', "imgMain" character varying, "year" character varying NOT NULL, "userId" uuid, CONSTRAINT "PK_b3ad760876ff2e19d58e05dc8b0" PRIMARY KEY ("id"))`);
