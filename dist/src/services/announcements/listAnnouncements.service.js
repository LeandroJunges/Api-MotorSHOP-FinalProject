...
const listAnnouncementsService = (req) => __awaiter(void 0, void 0, void 0, function* () {
    const announcementRepository = data_source_1.default.getRepository(Announcement_entity_1.Announcement);
    const announcements = yield announcementRepository.find();
    const filters = req;
    ...
    filteredAnnouncements.forEach((ann) => {
        const { user, comments, bids, imgs } = ann, rest = __rest(ann, ["user", "comments", "bids", "imgs"]);
...
exports.default = listAnnouncementsService;
